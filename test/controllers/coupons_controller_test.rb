...
class CouponsControllerTest < ActionController::TestCase
  ...
  test "should create coupon" do
    assert_difference('Coupon.count') do
      post :create, coupon: { end_time: @coupon.end_time, openid: @coupon.openid, price: @coupon.price, start_time: @coupon.start_time }
    end
  ...
  test "should update coupon" do
    patch :update, id: @coupon, coupon: { end_time: @coupon.end_time, openid: @coupon.openid, price: @coupon.price, start_time: @coupon.start_time }
    assert_redirected_to coupon_path(assigns(:coupon))
  end
